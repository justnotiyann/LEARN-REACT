...
function bo(e, n, t, r) {
    if (Dr) {
        var l = co(e, n, t, r);
        if (l === null) Dl(e, n, r, Ir, t), Xu(e, r);
    ...
    nl = A({}, Gt, {
        ...
        movementX: function (e) {
            return "movementX" in e
                ...
                : (e !== pt &&
                      (pt && e.type === "mousemove"
                          ? ((xl = e.screenX - pt.screenX),
                            (Nl = e.screenY - pt.screenY))
                          : (Nl = xl = 0),
                      (pt = e)),
                  xl);
        },
...
var wf = We && "TextEvent" in window && !Ct,
...
function $s(e) {
    if (e.propertyName === "value" && tl(Ft)) {
        var n = [];
        js(n, Ft, e, Go(e)), gs(Cf, n);
    }
}
function xf(e, n, t) {
    e === "focusin"
        ? (li(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", $s))
        : e === "focusout" && li();
}
function Nf(e) {
...
function _o(e, n, t, r) {
    var l = e.stateNode;
    (l.props = t), (l.state = e.memoizedState), (l.refs = ra), du(e);
    var o = n.contextType;
    typeof o == "object" && o !== null
        ? (l.context = Ce(o))
...
function Ti(e, n, t, r, l) {
    ...
    if ((Gn(n, l), n.stateNode === null))
        xr(e, n), la(n, t, r), _o(n, t, r, l), (r = !0);
    else if (e === null) {
        var u = n.stateNode,
            i = n.memoizedProps;
        u.props = i;
...
function bf(e, n, t, r, l, o, u) {
    ...
    if (l.data === "$!") {
        ...
        return (
            (r = i), (o = Error(y(419))), (r = Vl(o, r, void 0)), pr(e, n, u, r)
        );
    }
    if (((i = (u & e.childLanes) !== 0), ae || i)) {
        ...
        return Pu(), (r = Vl(Error(y(421)))), pr(e, n, u, r);
    }
    return l.data === "$?"
        ? ((n.flags |= 128),
          (n.child = e.child),
...
function ld(e, n) {
    ...
    for (
        vo = { focusedElem: e, selectionRange: t }, Dr = !1, S = n;
        S !== null;
...
function de(e, n) {
    ...
    if (r === 0)
        ...
        if ((t != null && Yu(t), n === 1))
            e.tag === 0 ? Bf($i.bind(null, e)) : Js($i.bind(null, e)),
                Uf(function () {
                    (R & 6) === 0 && vn();
                }),
                (t = null);
...
hs = xu;
ys = Ln;
var kd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, ms, vs, xu] },
    ht = {
...
const Te = Mu.exports.jsx,
    Wi = Mu.exports.jsxs;
function zd(e) {
    const { color: n, text: t } = e;
    return Te("button", { ...e, className: `btn btn-${n} mt-2`, children: t });
}
const Ld = "/assets/hero.120c70ab.svg";
function Td(e) {
    return Te("div", {
        className: "container",
        children: Wi("div", {
            ...
            children: [
                Wi("div", {
                    className: "col-6",
                    children: [
                        Te("h1", { children: "Selamat Datang Di Toko Kami" }),
                        Te("p", {
                            children:
...
Ql.createRoot(document.getElementById("root")).render(
    Te(gc.StrictMode, { children: Te(Rd, {}) })
);
